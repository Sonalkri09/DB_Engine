...
import java.util.Date;  
		...
		public class csvfile {
		    ...
		    public static void main(String[] args)throws Exception {
		       ...
		       try
		       {
		       FileReader ip=new FileReader("C:\\Users\\User\\workspace\\database\\src\\database\\ipl.csv");
		       try
		       {
		      ...
		      for (int i=1;i<=577;i++)
		      {
		    	 ...
		    	 /* for (int i=1;i<=577;i++)
		    	  ...
		    	  FileReader ip1 = new FileReader("C:\\Users\\User\\workspace\\database\\src\\database\\ipl.csv");
